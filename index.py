...
# --- CONEXÃO SUPABASE (Lógica Intacta) ---
...
LOVABLE_CSS = """
    <style>
        ...
        /* --- HISTÓRICO CUSTOMIZADO (SEM ST.DATAFRAME) --- */
        .history-container {
...
if df.empty:
    ...
    # --- ESQUERDA: HERO CARD (Centralizado & Laranja) ---
    with col_left:
        latest = df.iloc[0]
    ...
    # --- DIREITA: RANKING + HISTÓRICO HTML ---
    with col_right:
        # Lógica Ranking
        ...
        # Histórico Recente (HTML Customizado - Nada de Tabela Feia)
        st.markdown(f"""
        ...
        # Pegar os últimos 6 registros para a lista
